...
<head>
  ...
  <title>ANDROShop | Registration Page</title>
...
<?php if (validation_errors() or $this->ion_auth->errors()): ?>
...
<?php endif ?>
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url('auth/create_member') ?>" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="tou"> I agree to the <a href="#">terms</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
